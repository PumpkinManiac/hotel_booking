  ...
  return (
    <div className="flex flex-col items-center  max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
            <div className="flex flex-col justify-center items-center text-center">
                <Title title='Stay Inspired' subtitle='Join our newsletter and be the first to discover new destinations , exclusive Offers, and travle inspiration.'/>
            </div>
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-6">
                ...
                <img src={assets.arrowIcon} alt='arrow-icon' className='w-3.5 invert group-hover:translate-x-1 transition-all'></img>
                </button>
            </div>
